                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <p>We wanted to notify you of a new account creation via the Ping Up app. Here are some customer details</p>
                                                                                <p>Name: <span>NAME</span></p>
                                                                                <p>CNIC: <span>CNIC_</span></p>
                                                                                <p>Date of Account Creation: <span>DATE_OF_CREATION</span></p>
                                                                                <p>Please do run this account creation; we have sent it through our APIs on the backend. </p>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
